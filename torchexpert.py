...
class TorchExpert:
    ...
    def update_stream_assignment(self):
        ...
        def check_one_graph(picked_events, ssgraph):
            ...
            for stream_id, events in picked_events_stream_assignment_newid.items():
                ...
                if len(events) != len(ssgraph.stream_assignment[stream_id]):
                    print("Warning: the number of kernels in stream {} is not equal to the number of kernels in stream_assignment.json.".format(stream_id))
            # update the stream assignment
...
if __name__ == "__main__":
    ...
    torchexpert.update_stream_assignment()
